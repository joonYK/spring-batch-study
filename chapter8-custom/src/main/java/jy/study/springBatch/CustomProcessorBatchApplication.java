...
public class CustomProcessorBatchApplication {
    ...
    @Bean
    public Step step() {
        return this.stepBuilderFactory.get("customProcessorStep")
    ...
    public static void main(String[] args) {
		SpringApplication.run(CustomProcessorBatchApplication.class, "customerFile=/input/customer.csv");
    }
}
